...
async def ingest_place(place):
    ...
    if place_selected.connected_persons:
        ...
        for connected_person in place_selected.connected_persons:
            connected_person.connection_comment, connected_person.connection_type = parse_relationship("location", "person", connected_person.connection_comment, connected_person.connection_type, "")
...
#                person_found = coll.find_one({"external_id": {"$elemMatch": {"name": external_id.name, "id": external_id.id}}}, {"id": 1, "name_preferred" : 1, "sex" : 1, "connected_locations" : 1})
                ...
                if person_found:
                    ...
                    type_correction, time_correction, comment_correction = db_actions.add_relationship_in_far_record(person_found, place_new, "connected_locations", connected_person.connection_type, connected_person.connection_time, connected_person.connection_comment) # This is step 2, the reciprocal connection
                    if type_correction != "":
    ...
    if place_selected.connected_organisations:
        for connected_org in place_selected.connected_organisations:
            connected_org.connection_comment, connected_org.connection_type = parse_relationship("location", "organisation", connected_org.connection_comment, connected_org.connection_type, "")
...
#                org_found = coll.find_one({"external_id": {"$elemMatch": {"name": external_id.name, "id": external_id.id}}}, {"id": 1, "name_preferred" : 1, "connected_locations" : 1})
                ...
                if org_found:
                    ...
                    type_correction, time_correction, comment_correction = db_actions.add_relationship_in_far_record(org_found, place_new, "connected_locations", connected_org.connection_type, connected_org.connection_time, connected_org.connection_comment) # This is step 2, the reciprocal connection
                    if type_correction != "":
...
#                    list_of_ids_to_check.append(connected_org.external_id[0].uri) # I just use the first ID given here, since all IDs should be in VIAF
    if place_selected.connected_locations:
        for connected_location in place_selected.connected_locations:
            connected_location.connection_comment, connected_location.connection_type = parse_relationship("location", "location", connected_location.connection_comment, connected_location.connection_type, "")
...
#                location_found = coll.find_one({"external_id": {"$elemMatch": {"name": external_id.name, "id": external_id.id}}}, {"id": 1, "name_preferred" : 1, "connected_locations" : 1})
                ...
                if location_found:
                    ...
                    type_correction, time_correction, comment_correction = db_actions.add_relationship_in_far_record(location_found, place_new, "connected_locations", connected_location.connection_type, connected_location.connection_time, connected_location.connection_comment) # This is step 2, the reciprocal connection
                    if type_correction != "":
...
#                        person_found = coll.find_one({"external_id": {"$elemMatch": {"name": external_id.name, "id": external_id.id}}}, {"id": 1, "name_preferred" : 1, "sex" : 1, "connected_locations" : 1})
                    ...
                    if person_found:
                        ...
                        db_actions.add_relationship_in_far_record(person_found, place_new, "connected_persons", connected_person.connection_type, connected_person.connection_time, connected_person.connection_comment) # This is step 2, the reciprocal connection
                        break
