...
#                    type_correction, time_correction, comment_correction = add_relationship_in_far_record(org_found, person_new, "connected_persons", connected_org.connection_type, connected_org.connection_time, connected_org.connection_comment), connected_org.connection_time # This is step 2, the reciprocal connection
                    ...
                    type_correction, time_correction, comment_correction = db_actions.add_relationship_in_far_record(org_found, person_new, "connected_persons", connected_org.connection_type, connected_org.connection_time, connected_org.connection_comment) # This is step 2, the reciprocal connection
...
#                        comment_correction = x[0][2]
    ...
    if person_selected.connected_locations:
        for connected_location in person_selected.connected_locations:
            connected_location.connection_comment, connected_location.connection_type = parsing_helpers.parse_relationship("person", "location", connected_location.connection_comment, connected_location.connection_type, person_new.sex)
...
#               location_found = coll.find_one({"external_id": {"$elemMatch": {"name": external_id.name, "id": external_id.id}}}, {"id": 1, "name_preferred" : 1, "connected_persons" : 1})
                ...
                if location_found:
                    ...
                    type_correction, time_correction, comment_correction = db_actions.add_relationship_in_far_record(location_found, person_new, "connected_persons", connected_location.connection_type, connected_location.connection_time, connected_location.connection_comment) # This is step 2, the reciprocal connection
                    if type_correction != "":
