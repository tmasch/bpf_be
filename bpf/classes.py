...
class Date(BaseModel):
    ...
    # The only current plan to use it is to determinate dates of life
    #  and dates of activity of a person.
    #    I can probably omit the date_type and have a separate class
    #  for dates of persons
    date_start: Optional[tuple] = ()
    date_end: Optional[tuple] = ()
...
#     """
#     This class is used for entering the link between manuscripts and
#  repositories into the database.
# It can probably be later also used for the link between artworks and
#  repositories
#     """
...
#     """
# Here, the name is the name of the repertory (e.g., VD16),
# the id the id of a book in the repertory
# and the uri the uri of the record of the book in the repertory.
# This class should be superseded everywhere by External_id, I keep 
# it for the moment just to be sure
#     """
# #    id : str
#     uri : Optional[str] = ""
#     name : Optional[str] = ""
...
class Edge(Document):
    ...
    external_id: Optional[List[ExternalReference]] = []
#    name: Optional[str] = ""
    # Name of the person, place or organisation for easier access
...
class Graph(Document):
    """
    This class is for graphs containing edges and nodes
    """
